        ...
        <div id="wrapper">
            ...
            <div id="main" class="alt">
                ...
                <section id="one">
                    <div class="inner">
                        <header class="major">
                            <h1>Mitsubishi Evolution X</h1>
                        </header>
                        <span class="image main"><img src="{{ asset('images/evo1.jpg') }}" alt="sti" style="width: 500px; height: auto;">
                        </span>
                        <p>The Lancer Evolution X sedan features a 4B11T 2.0L (1998cc) turbocharged, all-aluminium inline-4 GEMA engine. Power and torque depend on the market but all versions have at least 280 PS (206 kW; 276 hp). (JDM version), the American market version has slightly more. The UK models were reworked by Mitsubishi UK, in accordance with previous MR Evolutions bearing the FQ badge. Options for the UK Evolutions are 300 hp (220 kW) and 360 hp (270 kW).</p>
                        </div>
                </section>
